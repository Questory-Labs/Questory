...
import { ScraperTestPanel } from "./ScraperTestPanel";
import { statusLabel } from "./ScraperIterationList";
...
const stepIndex = (status: ScraperIterationRecord["status"]): number => {
...
export const ScraperIterationWorkflow = ({
  providerKey,
  detail,
}: Props) => {
