...
export type QMarkVariant = "loading" | "error";

export const QMark = ({ variant }: { variant: QMarkVariant }) => {
  ...
  return (
    <div
      className={`qc-root relative inline-flex items-center justify-center${isError ? " qc-anim-shake" : ""}`}
      style={rootStyle}
    >
      <svg
        viewBox={`0 0 ${S} ${S}`}
